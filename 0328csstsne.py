...
MODEL_PATH = None  # supervised 모델을 저장했다면 경로 지정
...
plt.legend()
plt.title("t-SNE of Supervised Encoder Embeddings")
plt.xlabel("Dim 1")
plt.ylabel("Dim 2")
plt.grid(True)
plt.tight_layout()
plt.savefig("tsne_supervised_embedding.png")
plt.show()